 ...
 */
public class Delete_result extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Delete_result
     */
    public Delete_result() {
        initComponents();
    }
     public Delete_result(String pera){
        initComponents();
        jLabel18.setText(pera);
    }
    
    public Delete_result(String pera,String pera1){
        initComponents();
        jLabel18.setText(pera);
    }
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        try{
            ...
            String sql="DELETE FROM results WHERE st_id='"+jTextField1.getText()+"' AND exam='"+jTextField2.getText()+"'";
            String sql1="DELETE FROM gpa WHERE st_id='"+jTextField1.getText()+"'";
            ...
            if(rs.next() && rs1.next()){
                ...
                String uname= jLabel18.getText();
                JOptionPane.showMessageDialog(rootPane,"Result deleted");
                new Results(uname,stid).setVisible(true);
                new Delete_result().setVisible(false);
                dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_result.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_result().setVisible(true);
            }
        });
    }
