 ...
 */
public class Edit_first_name1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_first_name1
     */
    public Edit_first_name1() {
        initComponents();
    }
    public Edit_first_name1(String pera,String pera1){
        initComponents();
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        // TODO add your handling code here:
        conn=DBConnection.ConnectDB();
        String sql="UPDATE students SET f_name='"+jTextField2.getText()+"' WHERE st_id='"+jLabel9.getText()+"'";
        try{
            pst=conn.prepareStatement(sql);
            int r=pst.executeUpdate();
            if(r>0){
                JOptionPane.showMessageDialog(rootPane,"Name updated");
                String uname= jLabel18.getText();
                new Edit_st_details(uname).setVisible(true);
                new Edit_address1().setVisible(false);
                dispose(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_first_name1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_first_name1().setVisible(true);
            }
        });
    }
