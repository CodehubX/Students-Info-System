 ...
 */
public class Edit_email1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_email1
     */
    public Edit_email1() {
        initComponents();
    }
     public Edit_email1(String pera,String pera1){
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Enter new email address");
        ...
        jLabel10.setText("Current email address");
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        // TODO add your handling code here:
        conn=DBConnection.ConnectDB();
        String sql="UPDATE students SET email='"+email.getText()+"' WHERE st_id='"+jLabel9.getText()+"'";
        ...
        try{
            ...
            if(r>0){
                JOptionPane.showMessageDialog(rootPane,"Email address updated");
                String uname= jLabel18.getText();
                new Edit_st_details(uname).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_email1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_email1().setVisible(true);
            }
        });
    }
