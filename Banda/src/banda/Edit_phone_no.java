 ...
 */
public class Edit_phone_no extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_phone_no
     */
    public Edit_phone_no() {
        initComponents();
    }
     public Edit_phone_no(String pera){
        initComponents();
        jLabel18.setText(pera);
    }
    
    public Edit_phone_no(String pera,String pera1){
        initComponents();
        jLabel18.setText(pera);
    }
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        try{
            ...
            if(rs.next()){
                ...
                String uname= jLabel18.getText();
                new Edit_phone_no1(uname,stid).setVisible(true);
                new Edit_phone_no().setVisible(false);
                dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_phone_no.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_phone_no().setVisible(true);
            }
        });
    }
