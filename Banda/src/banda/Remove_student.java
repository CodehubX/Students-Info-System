...
public class Remove_student extends javax.swing.JFrame {
    ...
    public Remove_student() {
     ...
     public Remove_student(String pera){
        initComponents();
        jLabel18.setText(pera);
    }
    
    public Remove_student(String pera,String pera1){
        initComponents();
        jLabel18.setText(pera);
    }
        ...
        // TODO add your handling code here:
         try{
            ...
            if(rs.next()){
             ...
             String uname= jLabel18.getText();
             new Remove_student1(uname,stid).setVisible(true);
             new Remove_student().setVisible(false);
             dispose();
            }
            else{
