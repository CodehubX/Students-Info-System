 ...
 */
public class Edit_last_name1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_last_name1
     */
    public Edit_last_name1() {
        initComponents();
    }
    public Edit_last_name1(String pera,String pera1){
        initComponents();
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        // TODO add your handling code here:
        conn=DBConnection.ConnectDB();
        String sql="UPDATE students SET l_name='"+jTextField2.getText()+"' WHERE st_id='"+jLabel9.getText()+"'";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_last_name1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_last_name1().setVisible(true);
            }
        });
    }
