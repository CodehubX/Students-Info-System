 ...
 */
public class Edit_profile_pic extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_profile_pic
     */
    public Edit_profile_pic() {
        initComponents();
    }
     public Edit_profile_pic(String pera){
        initComponents();
        jLabel18.setText(pera);
    }
    
    public Edit_profile_pic(String pera,String pera1){
        initComponents();
        jLabel18.setText(pera);
    }
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        try{
            ...
            if(rs.next()){
                ...
                String uname= jLabel18.getText();
                new Edit_profile_pic1(uname,stid).setVisible(true);
                new Edit_profile_pic().setVisible(false);
                dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_profile_pic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_profile_pic().setVisible(true);
            }
        });
    }
