 ...
 */
public class Edit_last_name extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_last_name
     */
    public Edit_last_name() {
        initComponents();
    }
     public Edit_last_name(String pera){
        initComponents();
        jLabel18.setText(pera);
    }
    
    public Edit_last_name(String pera,String pera1){
        initComponents();
        jLabel18.setText(pera);
    }
        ...
        // TODO add your handling code here:
         try{
            ...
            if(rs.next()){
             ...
             String uname= jLabel18.getText();
             new Edit_last_name1(uname,stid).setVisible(true);
             new Edit_last_name().setVisible(false);
             dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_last_name.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_last_name().setVisible(true);
            }
        });
    }
