 ...
 */
public class Edit_address extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_address
     */
    public Edit_address() {
        initComponents();
    }
    
     public Edit_address(String pera){
        initComponents();
        jLabel18.setText(pera);
    }
    
    public Edit_address(String pera,String pera1){
        initComponents();
        jLabel18.setText(pera);
    }
        ...
        // TODO add your handling code here:
          try{
            ...
            if(rs.next()){
             ...
             String uname= jLabel18.getText();
             new Edit_address1(uname,stid).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_address.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_address().setVisible(true);
            }
        });
    }
