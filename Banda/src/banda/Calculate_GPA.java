 ...
 */
public class Calculate_GPA extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Calculate_GPA
     */
    public Calculate_GPA() {
        initComponents();
    }
     public Calculate_GPA(String pera){
        initComponents();
        jLabel18.setText(pera);
    }
    
    public Calculate_GPA(String pera,String pera1){
        initComponents();
        jLabel18.setText(pera);
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon("C:\\Users\\Viraj Dissanayake\\Documents\\NetBeansProjects\\Banda\\dark\\appbar.chevron.left.png")); // NOI18N
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        try{
            ...
            if(rs.next()){
                ...
                String uname= jLabel18.getText();
                new Calculate_GPA1(uname,stid).setVisible(true);
                new Calculate_GPA().setVisible(false);
                dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calculate_GPA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculate_GPA().setVisible(true);
            }
        });
    }
