 ...
 */
public class Edit_email extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_email
     */
    public Edit_email() {
        initComponents();
    }
     public Edit_email(String pera){
        initComponents();
        jLabel18.setText(pera);
    }
    
    public Edit_email(String pera,String pera1){
        initComponents();
        jLabel18.setText(pera);
    }
        ...
        // TODO add your handling code here:
         try{
            ...
            if(rs.next()){
             ...
             String uname= jLabel18.getText();
             new Edit_email1(uname,stid).setVisible(true);
             new Edit_email().setVisible(false);
             dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_email.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_email().setVisible(true);
            }
        });
    }
