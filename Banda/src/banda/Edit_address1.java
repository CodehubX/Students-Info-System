 ...
 */
public class Edit_address1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_address1
     */
    ...
    public Edit_address1(String pera,String pera1){
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Enter new Address");
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        ...
        String sql="UPDATE students SET address='"+jTextArea2.getText()+"' WHERE st_id='"+jLabel9.getText()+"'";
        try{
            pst=conn.prepareStatement(sql);
            int r=pst.executeUpdate();
            if(r>0){
                JOptionPane.showMessageDialog(rootPane,"Address updated");
                String uname= jLabel18.getText();
                new Edit_st_details(uname).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_address1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_address1().setVisible(true);
            }
        });
    }
