 ...
 */
public class Edit_phone_no1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_phone_no1
     */
    public Edit_phone_no1() {
        initComponents();
    }
    public Edit_phone_no1(String pera,String pera1){
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Enter new phone no:");
        ...
        jLabel10.setText("Current phone no:");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(341, 382, Short.MAX_VALUE)
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        ...
        String sql="UPDATE students SET p_no='"+phone.getText()+"' WHERE st_id='"+jLabel9.getText()+"'";
        
        //validate phone no
                  String tpNo=phone.getText();
    ...
    private void jPanel1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseEntered
        ...
        try{
            ...
            if(rs.next()){
                jTextField1.setText(rs.getString("p_no"));
    ...
    private void phoneKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_phoneKeyPressed
        ...
        if((key>=java.awt.event.KeyEvent.VK_0 && key<=evt.VK_9)||(key>=evt.VK_NUMPAD0 && key<=evt.VK_NUMPAD9)||key==KeyEvent.VK_BACKSPACE){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_phone_no1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Edit_phone_no1().setVisible(true);
            }
        });
    }
