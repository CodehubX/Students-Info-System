...
public class Update_result extends javax.swing.JFrame {
    ...
    public Update_result() {
     ...
     public Update_result(String pera){
        initComponents();
        jLabel18.setText(pera);
    }
    
    public Update_result(String pera,String pera1){
        initComponents();
        jLabel18.setText(pera);
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Enter new result");
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        try{
            ...
            String sql="UPDATE results SET result="+jTextField3.getText()+" WHERE st_id='"+jTextField1.getText()+"'";
            String sql1="SELECT SUM(result)/COUNT(st_id) AS GPA FROM results WHERE st_id='"+jTextField1.getText()+"' GROUP BY st_id";
            String sql2="UPDATE gpa SET GPA="+GPA+" WHERE st_id='"+jTextField1.getText()+"'";
            String sql4="SELECT * FROM gpa WHERE st_id='"+jLabel9.getText()+"'";
            String sql5="INSERT INTO gpa(GPA,st_id) VALUES("+GPA+",'"+jLabel9.getText()+"')";
            ...
            if(rs>0){
                ...
                if(rs4.next()){
                  int rs2=st3.executeUpdate(sql2);
                }
                else{
                  int rs3=st5.executeUpdate(sql5);
                }
                String stid= jTextField1.getText();
                String uname= jLabel18.getText();
                JOptionPane.showMessageDialog(rootPane,"Results updated");
                new Results(uname,stid).setVisible(true);
                new Update_result().setVisible(false);
                dispose();
            }
            else{
                JOptionPane.showMessageDialog(rootPane,"No matching data exists..!");
            }
        }
        catch(Exception e){
