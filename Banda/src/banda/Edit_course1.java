 ...
 */
public class Edit_course1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Edit_course1
     */
    public Edit_course1() {
        initComponents();
    }
     public Edit_course1(String pera,String pera1){
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel28.setText("Select course");
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        // TODO add your handling code here:
        conn=DBConnection.ConnectDB();
        String sql="UPDATE students SET course='"+jComboBox1.getSelectedItem().toString()+"' WHERE st_id='"+jLabel9.getText()+"'";
        try{
            pst=conn.prepareStatement(sql);
            int r=pst.executeUpdate();
            if(r>0){
                JOptionPane.showMessageDialog(rootPane,"Course updated");
                String uname= jLabel18.getText();
                new Edit_st_details(uname).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_course1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_course1().setVisible(true);
            }
        });
    }
