 ...
 */
public class Remove_student1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Remove_student1
     */
    public Remove_student1() {
        initComponents();
    }
     public Remove_student1(String pera,String pera1){
        initComponents();
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        // TODO add your handling code here:
        conn=DBConnection.ConnectDB();
        String sql="DELETE FROM students WHERE st_id='"+jLabel9.getText()+"'";
        String sql1="DELETE FROM results WHERE st_id='"+jLabel9.getText()+"'";
        String sql2="DELETE FROM gpa WHERE st_id='"+jLabel9.getText()+"'";
        try{
            Statement st=conn.createStatement();
            ...
            if(r>0){
                JOptionPane.showMessageDialog(rootPane,"Student record removed!");
                String uname= jLabel18.getText();
                new Edit_st_details(uname).setVisible(true);
                new Edit_course1().setVisible(false);
                dispose(); 
        }
            else{
              JOptionPane.showMessageDialog(rootPane, "Error generated while executing this option..!");
            }
        }
        catch(Exception e){
          JOptionPane.showMessageDialog(null, e);}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Remove_student1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Remove_student1().setVisible(true);
            }
        });
    }
